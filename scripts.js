    ...
    const timelineData = [
        {
            ...
            description: 
                `<ul class="experience-list">
                    ...
                    <li><span class="bullet"></span> Utilized SQL to query server and application logs, identifying health and performance issues by analyzing key metrics that impact infrastructure reliability i.e. resource utilization, error rates, and response times.</li>
                </ul>`
        },
        {
            date: '2019 – 2022',
